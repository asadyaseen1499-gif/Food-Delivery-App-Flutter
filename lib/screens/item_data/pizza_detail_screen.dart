...
class _PizzaDetailScreenState extends State<PizzaDetailScreen> {
  ...
  int get _currentPrice {
    final flavor = PizzaData.menu[_selectedFlavorIndex];
              ...
              child: Theme(
                ...
                child: Scrollbar(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: PizzaData.menu.length,
                    itemBuilder: (context, index) {
                      final flavor = PizzaData.menu[index];
                      return InkWell(
                        onTap: () {
                          setState(() {
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: PizzaData.sizes.map((size) {
                    ...
                    // Dropdown Label
                    Text("Select Flavor", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 10),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                PizzaData.menu[_selectedFlavorIndex]['name'],
            ...
            Container(
              ...
              child: CustomButton(
                text: "Add to Cart",
                onPressed: () {
                  final item = PizzaData.menu[_selectedFlavorIndex];
                  final String name = "${item['name']} ($_selectedSize)";
                  final String price = _currentPrice.toString();
                  // Using Asset Image here
                  const String img = "assets/images/pizza.jpg";
