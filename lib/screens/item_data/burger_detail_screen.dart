...
class _BurgerDetailScreenState extends State<BurgerDetailScreen> {
  ...
  int get _currentPrice {
    return BurgerData.menu[_selectedIndex]['price'];
  }
              ...
              child: Theme(
                ...
                child: Scrollbar(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: BurgerData.menu.length,
                    itemBuilder: (context, index) {
                      final burger = BurgerData.menu[index];
                      return InkWell(
                        onTap: () {
                          setState(() {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _selectedIndex == index ? Colors.grey[50] : Colors.white,
                            border: Border(bottom: BorderSide(color: Colors.grey.shade100)),
                          ),
                          // 3. REMOVED PRICE HERE - ONLY SHOW NAME
                          child: Text(
                            burger['name'],
  ...
  Widget build(BuildContext context) {
    final currentBurger = BurgerData.menu[_selectedIndex];
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Dropdown Label
                    Text("Choose a Burger", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
            ...
            Container(
              ...
              child: CustomButton(
                text: "Add to Cart",
                onPressed: () {
                  final String name = currentBurger['name'];
                  final String price = _currentPrice.toString();
                  const String img = "assets/images/burger.jpg";
